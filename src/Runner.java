...
public class Runner extends GymBro implements IGetMoreAthletic, IGetSportTitle{
    Random random = new Random();
    public Runner(String name, int age, double weight) {
            ...
            case "Easy":
                switch (skill_of_run){
                    ...
                    case "pro":
                        if (win>3){
                            numOfTrophies+=1;
                            System.out.printf("Спокойно эту гонку выигрывает %s, мои поздравления!\n+1 трофей в вашей копилке\n" +
                                    "Всего трофеев: %d\n\n",name,numOfTrophies);
                        }
                        else System.out.printf("Поражение...\nНичего страшного, тренировки тебе помогут набраться опыта и навыка\n" +
                                "Всего трофеев: %d\n", numOfTrophies);
                    ...
                    case "legend":
                        if (win>1) {
                            numOfTrophies+=1;
                            System.out.printf("Это была легкая прогулка для %s, мои поздравления!\n+1 трофей в вашей копилке\n" +
                                    "Всего трофеев: %d\n\n",name,numOfTrophies);
                        }
                        else System.out.printf("Поражение...\nНеожиданно %s упускает победу на финише\n" +
                                "Всего трофеев: %d\n\n", name, numOfTrophies);
                        break;
                }
                timeOfTrains+=5;
